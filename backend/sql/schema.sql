...
CREATE TABLE tabs (
    ...
    columns_json    NVARCHAR(MAX)   NOT NULL DEFAULT '["todo","in-progress","developed","in-code-review","reviewed","in-qa","done"]',
...
CREATE TABLE agents (
    ...
    kind            VARCHAR(20)     NOT NULL DEFAULT 'editor' CHECK (kind IN ('editor','inspector')),
