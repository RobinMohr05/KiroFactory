...
export function logSessionEvent(
  event: "session-created" | "session-started" | "session-stopped" | "session-error" | "session-deleted" | "session-retry" | "session-tabs-updated" | "session-pin-changed" | "session-reordered",
  sessionId: number,
  data?: Record<string, unknown>
): void {
