...
(`40978307-de4a-44a0-9d2a-e6d9ef2bb577`), resource group **`SandboxForRM`**,
...
| `rm-sandbox` | Azure SQL Server | Database server. `rm-sandbox.database.windows.net`. |
...
```bash
export DB_SERVER=rm-sandbox.database.windows.net DB_USER=<user> DB_PASSWORD=<pw>
